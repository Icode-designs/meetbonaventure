...
export default function EditCaseStudy() {
      ...
      try {
        ...
        if (data) {
          setFormData({
            ...
            problems: data.problems ? data.problems.join('\n') : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (updateError) throw new Error(`Failed to update case study: ${updateError.message}`);
  ...
  if (fetching) {
    return (
      <PageContainer>
        <p style={{ color: "#a0a0a0" }}>Fetching Case Study...</p>
      </PageContainer>
    );
  }
  ...
  return (
    <PageContainer>
      <h1 style={{ marginBottom: "32px", fontSize: "28px" }}>Edit Case Study</h1>
